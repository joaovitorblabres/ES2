...
class VoluntariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voluntario" do
    assert_difference('Voluntario.count') do
      post voluntarios_url, params: { voluntario: { contato: @voluntario.contato, cpf: @voluntario.cpf, informacao: @voluntario.informacao, nome: @voluntario.nome } }
    end
  ...
  test "should update voluntario" do
    patch voluntario_url(@voluntario), params: { voluntario: { contato: @voluntario.contato, cpf: @voluntario.cpf, informacao: @voluntario.informacao, nome: @voluntario.nome } }
