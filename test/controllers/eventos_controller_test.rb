...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { dataEvento: @evento.dataEvento, horaFim: @evento.horaFim, horaInicio: @evento.horaInicio, latitude: @evento.latitude, longitude: @evento.longitude } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { dataEvento: @evento.dataEvento, horaFim: @evento.horaFim, horaInicio: @evento.horaInicio, latitude: @evento.latitude, longitude: @evento.longitude } }
