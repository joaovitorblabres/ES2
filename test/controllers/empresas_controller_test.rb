...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post empresas_url, params: { empresa: { contato: @empresa.contato, cpnj: @empresa.cpnj, nome: @empresa.nome } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { contato: @empresa.contato, cpnj: @empresa.cpnj, nome: @empresa.nome } }
